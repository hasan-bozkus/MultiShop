...
namespace MultiShop.WebUI.Services.Concrete
{
    public class ClientCredentialTokenService : IClientCredentialTokenService
    {
        ...
        public async Task<string> GetToken()
        {
            ...
            var clientCredentialTokenResponse = new ClientCredentialsTokenRequest
            {
            ...
            var newToken = await _httpClient.RequestClientCredentialsTokenAsync(clientCredentialTokenResponse);
